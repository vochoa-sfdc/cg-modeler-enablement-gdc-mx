 ...
 * @description Handles promotion workflow state transitions by updating the state, responsible user, and refreshing access rights.
 * @returns promise
 */
...
var promise = boWorkflow.getNextResponsible(nextStatePKey, me.getResponsiblePKey(), me.getOwnerPKey())
  ...
  if (Utils.isDefined(nextResponsible)) {
    ...
    return me.loadLookupsAsync(jsonParamsForLookup)
