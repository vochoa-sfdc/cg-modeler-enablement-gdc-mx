...
if (me.getMode() !== "ReviewStock") {
  ...
  if (me.getPhase() === "Released" && Utils.isEmptyString(me.getInwardTransferDocumentPKey()) && syncOption == BLConstants.SYNC.SYNC_OPTION_RELEASE || syncOption == BLConstants.SYNC.SYNC_OPTION_RELEASE_CANCEL) {
    deferreds.push(Facade.startBackgroundReplication());
  }

  if (me.getPhase() === "Canceled" && syncOption == BLConstants.SYNC.SYNC_OPTION_CANCEL || syncOption == BLConstants.SYNC.SYNC_OPTION_RELEASE_CANCEL) {
    deferreds.push(Facade.startBackgroundReplication());
  }
