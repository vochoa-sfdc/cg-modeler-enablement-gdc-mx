 ...
 * @kind businessobject
 * @namespace CORE
 * @deprecated 'Truck Load' module no longer used 
 */
function setEARights(){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
...
if (
    //(Utils.isDefined(ApplicationContext.get('currentTourStatus')) && ApplicationContext.get('currentTourStatus').toLowerCase() !== "running") ||
...
if (Utils.isDefined(me.getBoOrderMeta()) && me.getDocumentType() === BLConstants.Order.DOCUMENT_TYPE_PRODUCT_CHECK_OUT && (me.getPhase() == "Canceled" || me.getPhase() == "Released")) {
...
if (me.isEditable() && me.getActualPrdCheckOutType() !== "Express") {
  if (Utils.isDefined(me.getBoOrderMeta()) && me.getDocumentType() === BLConstants.Order.DOCUMENT_TYPE_PRODUCT_CHECK_OUT && me.getBoOrderMeta().getItemPresettingPolicy() !== "Prepopulated") {
