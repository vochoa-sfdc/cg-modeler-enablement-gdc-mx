...
if(Utils.isDefined(ApplicationContext.get(BLConstants.APPCTX.DSD.CURRENT_TOUR))){
  var defaultEtpVehiclePKey =  ApplicationContext.get(BLConstants.APPCTX.DSD.CURRENT_TOUR).getDefaultEtpVehicleTruckPKey();
  var etpVehiclePKey =ApplicationContext.get(BLConstants.APPCTX.DSD.CURRENT_TOUR).getEtpVehicleTruckPKey();
