...
var promise = when.resolve(SysReleaseProcessPKey);
...
/* if(Utils.isDefined(ApplicationContext.get('currentTourPKey')) && ApplicationContext.get('currentTourStatus') === "Running") {
  ...
  if (docSdoSubType === BLConstants.Order.DOCUMENT_TYPE_PRODUCT_CHECK_OUT){
    usage = "SdoMeta.ProductCheckOut";
  }else if (docSdoSubType === BLConstants.Order.DOCUMENT_TYPE_PRODUCT_CHECK_IN){
    usage = "SdoMeta.ProductCheckIn";
  }else if (docSdoSubType === BLConstants.Order.DOCUMENT_TYPE_TRUCK_AUDIT){
