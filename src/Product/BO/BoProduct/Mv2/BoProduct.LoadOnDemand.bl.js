...
if (loadMode === "Logistics" && !Utils.isDefined(me.getLoLogistics())) {
  promise = BoFactory.loadObjectByParamsAsync(LO_LOGISTICS, {
    params: [
      {
        field: "ProductPKey",
        value: me.getPKey(),
...
if (loadMode === "Attachments" && !Utils.isDefined(me.getLoPrdAttachments())) {
  promise = BoFactory.loadObjectByParamsAsync(LO_PRDATTACHMENTS, {
    params: [
      {
        field: "ProductPKey",
        value: me.getPKey(),
...
if (loadMode === "BoM" && !Utils.isDefined(me.getLoProductBoM())) {
  promise = BoFactory.loadObjectByParamsAsync(LO_PRODUCTBOM, {
    params: [
      {
        field: "ProductPKey",
        value: me.getPKey(),
