...
var promise = Facade.getObjectAsync(BO_PRODUCT, jsonQuery).then(
  ...
  function (lookups) {
    ...
    return BoFactory.loadObjectByParamsAsync("LuProductBasePrice", {
      params: [
        {
          field: "pKey",
          value: me.getPKey(),
  ...
  function (luProductBasePrice) {
    ...
    return BoFactory.loadListAsync(LO_PRODUCTHIERARCHY, {
      params: [
        {
          field: "ProductPKey",
          value: me.getPKey(),
  ...
  function (loProductHierarchy) {
    ...
    return BoFactory.loadListAsync(LO_PRDSTATEFORMASTERDATA, {
      params: [
        {
          field: "ProductPKey",
          value: me.getPKey(),
