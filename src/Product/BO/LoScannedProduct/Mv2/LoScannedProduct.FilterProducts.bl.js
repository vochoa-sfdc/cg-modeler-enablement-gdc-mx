 ...
 * @description This function filters products based on the fieldStateFilter and allowForeignProducts parameters.
 */
  ...
  if (items.length > 1){
    ...
    for (var index = 0; index < items.length; index++){
      ...
      if (products.indexOf(productId) === -1){
        ...
        maxLength = Math.max(maxLength, me.getItems().length);
