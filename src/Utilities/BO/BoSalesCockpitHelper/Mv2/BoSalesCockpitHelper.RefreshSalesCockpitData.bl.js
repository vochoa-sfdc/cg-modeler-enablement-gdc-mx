 ...
 * @description This function refreshes the sales cockpit data by setting various messages and user-specific information based on the provided date and user role.
