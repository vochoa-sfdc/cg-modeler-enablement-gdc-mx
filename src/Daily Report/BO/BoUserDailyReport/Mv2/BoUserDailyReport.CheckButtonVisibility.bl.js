 ...
 * @param {String} mode
 * @returns visible
 * @description this function check the visibility of menu items on the basis of various modes, current responible user, phase of daily report, workflow state and other template settings
 */
