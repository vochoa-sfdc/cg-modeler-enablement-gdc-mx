 ...
 * @async
 * @namespace CORE
 * @description This function validates that the total duration of all daily activities should be less than or equal to one day.
...
var loActivities = me.getLoUsrDRActivity().getItems();
