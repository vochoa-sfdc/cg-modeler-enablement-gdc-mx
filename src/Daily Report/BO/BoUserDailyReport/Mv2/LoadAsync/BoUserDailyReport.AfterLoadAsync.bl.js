...
var promise = Facade.getObjectAsync(BO_USERDAILYREPORT, context.jsonQuery).then(
  function (boUserDailyReport) {
    ...
    //### Load User Doc Meta ###
    //##########################
    return BoFactory.loadObjectByParamsAsync(BO_USERDOCMETA, {
      params: [
        {
          field: "pKey",
  ...
  function (luUser){
    ...
    //### Load UsrAnnotation ###
    //########################## 
    return BoFactory.loadObjectByParamsAsync(BO_USERDRANNOTATION, {
      params: [
        {
          field: "usrDocPKey",
          value: me.getPKey(),
  ...
  function (boUserAnnotation) {
    ...
    //############################# 
    return BoFactory.loadListAsync(LO_USRDRACTIVITY, {
      params: [
        {
          field: "usrDocPKey",
          value: me.getPKey(),
