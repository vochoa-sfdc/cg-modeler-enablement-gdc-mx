 ...
 * @returns promise
 * @description this function updates the time atributes of all list items of User time entry based on various attributes.
 */
...
if (!Utils.isDefined(me.getLoUsrTimeEntry()) || (Utils.isDefined(me.getLoUsrTimeEntry()) && me.getLoUsrTimeEntry().getItems().length === 0)) {
  
  promise = BoFactory.loadListAsync(LO_USRTIMEENTRY, { "params": 
    [
