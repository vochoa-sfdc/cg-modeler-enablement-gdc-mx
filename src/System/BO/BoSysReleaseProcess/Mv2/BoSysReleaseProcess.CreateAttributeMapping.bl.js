...
if(me.getReadOnlyMode() != "1"){
  ...
  switch(setName){
    ...
    case BLConstants.Order.DOCUMENT_TYPE_PRODUCT_CHECK_OUT:
      attrList = me.createAttrMappingProductCheckOut();
      break;

    case BLConstants.Order.DOCUMENT_TYPE_PRODUCT_CHECK_IN:
      attrList = me.createAttrMappingProductCheckIn();
      break;

    case BLConstants.Order.DOCUMENT_TYPE_TRUCK_AUDIT:
      attrList = me.createAttrMappingTruckAudit();
      break;

    case BLConstants.Order.DOCUMENT_TYPE_CASH_CHECK_OUT:
      attrList = me.createAttrMappingCashCheckOut();
      break;

    case BLConstants.Order.DOCUMENT_TYPE_CASH_CHECK_IN :
