 ...
 * @returns promise
 * @description This function is called after the BoVisit is loaded asynchronously.
 *   - It sets the planned start and end dates and times, and the actual start and end dates and times.
 *   - It also sets the object status and EARights.
 *   - It also sets the duration of the visit.
 *   - It also sets the actual start and end times if they are not empty.
 *   - It also increases the end time by 60 minutes if the end time is 23:00 or later.
 * It also sets the planned end date to the planned start date if the planned end time is empty.
 */
...
function increaseEndTimeBy60Mins() {
  let newTimeThru = Utils.convertAnsiTime2Time(me.getPlannedStartTime());
