...
function updateLastCallDate(customerPKey, clbMetaPKey, lastCallDate){
	...
	var lValidCallSettings = me.getItemsByParamArray([{"validFrom": lastCallDate, "op":"LE"}, {"validThru": lastCallDate, "op":"GE"}]);
	...
	else
	{
		...
		var lFutureCallSettings = me.getItemsByParamArray([{"validFrom": lastCallDate, "op":"GE"}]);
		...
		me.addListItems([liNewCallSetting]);
	}
