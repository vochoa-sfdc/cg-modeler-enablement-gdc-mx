...
var promise = Facade.getObjectAsync(BO_CONTACTPARTNER, jsonQuery).then(
  function (selfJson) {
    ...
    return BoFactory.loadListAsync("LoContactPartnerAddress", {
      params: [
        {
          field: "referencePKey",
          value: me.getPKey(),
  ...
  function (loBpaAddressJson) {
    ...
    return BoFactory.loadListAsync(LO_CUSTOMERCONTACTPARTNERRELATION, {
      params: [
        {
          field: "toPKey",
          value: me.getPKey(),
  ...
  function (loContactPartnerCustomerRelationJson) {
    var newParams = Utils.identity(jsonQuery);
