 ...
 * @description This function displays the component name as CardNoDataMessageUiPlugin if there exist no items in the given lo or with type TourMessage
...
if (type == 'TourMessage'){
  if(loItems.getCount() != 0 && loItems.getAllItems()[0] && Utils.isEmptyString(loItems.getAllItems()[0].message)){
      sDisplayedSubcomponentName = "CardNoDataMessageUiPlugin"; 
  }
} 
