 ...
 * @namespace CORE
 * @returns promise
 * @description Prepares calendar-related user settings including view preferences, map display options, 
 * time intervals, and first day of week setting and links it to user BO.
 */
function getCallCalendarSettings(){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
...
var loUserSettings = BoFactory.instantiate(LO_USERSETTING);

var promise = Facade.getObjectAsync(LU_SYSSETTINGBYID, {iD: 'FirstDayOfWeek'}).then(
  function (settingLookup) {
    ...
    return when.resolve(loUserSettings);
  }
);
