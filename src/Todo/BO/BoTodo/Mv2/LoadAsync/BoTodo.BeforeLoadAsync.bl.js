...
var promise = Facade.getObjectAsync(BO_TODO, jsonQuery).then(
  ...
  function (lookups) {
    ...
    return BoFactory.loadObjectByParamsAsync(BO_TODONOTE, {
      params: [
        {
          field: "svcTodoPKey",
          value: me.getPKey(),
  ...
  function (boTodoNote) {
    ...
    return BoFactory.loadObjectByParamsAsync(BO_SVCREQUESTMETA, {
      params: [
        {
          field: "pKey",
          value: me.getSvcRequestMetaPKey(),
          operator: "EQ"
        }
      ]
    });
  ...
  function (boWorkflow) {
    ...
    return BoFactory.loadListAsync(LO_TODORECENTSTATE, {
      params: [
        {
          field: "svcTodoPKey",
          value: me.getPKey(),
