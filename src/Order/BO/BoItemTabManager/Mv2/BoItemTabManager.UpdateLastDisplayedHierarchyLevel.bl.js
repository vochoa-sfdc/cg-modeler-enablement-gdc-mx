...
var hierarchyInformation = me.getLastDisplayedHierarchyLevel();
...
if (levelId != "RESET") {
  ...
  var hierarchyFilterItems = me.getBoOrder().getLoItemFilter().getItemsByParam({"filterCode" : "Hierarchy"});

  if (hierarchyFilterItems.length > 0) {
    me.getBoOrder().getLoItemFilter().setCurrent(hierarchyFilterItems[0]);
  }
}
