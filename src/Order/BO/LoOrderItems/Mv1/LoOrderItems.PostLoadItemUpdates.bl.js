 ...
 * @description Function is setting group names and sorts.
 *  Also is is setting a out of stock flag and taking care of correct item pKey and object status.
 */
...
for(var i=0; i < orderItems.length; i++) {
  ...
  //set free item to isOrderUnit = 1  --> needed to generate the UoM information string visible in order UI
  if(me.isFreeItem(orderItem)){
    orderItem.setIsOrderUnit("1");
  }
