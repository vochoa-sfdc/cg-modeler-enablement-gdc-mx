 ...
 * @returns promise
 * @description Function is returning a JSON object containing the given category and a dictionary containing the relevant UOM records for the given product keys.
 */
