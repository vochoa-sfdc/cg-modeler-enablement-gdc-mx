 ...
 * @description Function is removing edit right of the item(s) if:
 *  a) considerDeliveryState of the item meta is "0" and delivery state of the item is "NotAvailable"
 *  b) mergeEngine_invalidated flag is "1"
 */
...
     if (Utils.isDefined(itemMeta[0])) {
    ...
    // Set items that are invalidated to editable = false
