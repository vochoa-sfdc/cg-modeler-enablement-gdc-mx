 ...
 * @returns info
 * @description Function is returning uom item information used to show in UI.
 *  For example information about the unit of measure and its quantities.
 */
...
if (orderMeta.getSdoSubType() === BLConstants.Order.DOCUMENT_TYPE_DELIVERY) {
 if (ApplicationContext.get('user').hasRole('TourUser') || orderMeta.getConsiderQuantitySuggestion() === "PQty") {
...
if(unitOfMeasureItem.getSpecialPromoted() == "1"){
  if(unitOfMeasureItem.getIsOrderUnit() == "1"){
    ...
    info.oQtyString = qtySuggestionPrefix + ": "+ unitOfMeasureItem.getSpecialQuantity();
