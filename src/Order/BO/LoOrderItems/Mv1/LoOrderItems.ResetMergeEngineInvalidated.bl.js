 ...
 * @returns promise
 * @description This method is called only for non-Initial orders,
 * since in this case temp table returns missing information for those persisted reward 
 * products which are not part of tactic.
...
var invalidItemPKeys = invalidItems.map(function(item){return item.getPKey();});
  var addCondSdoItemPKeys = "Order_Item__c.Id IN ('" + invalidItemPKeys.toString() + "') ";
