...
var promise = Facade.getObjectAsync(BO_ORDERMETA, context.jsonQuery).then(
  function (selfJson) {
    ...
    return BoFactory.loadListAsync(LO_ORDERITEMMETAS, {
      params: [
        {
          field: "sdoMetaPKey",
          value: me.getPKey(),
  ...
  function (loOrderItemMetasJson) {
    if (Utils.isDefined(loOrderItemMetasJson.getMainItemTemplate()) ||
      ...
      return BoFactory.loadListAsync(LU_ORDERMETAFORFREEITEMS, {
        params: [
          {
            field: "sdoMetaPKey",
            value: me.getPKey(),
        ...
        function (luOrderMetaForFreeItems) {
          ...
          return BoFactory.loadListAsync(LO_INVENTORYMETABYITEMMETA, {
            params: [
              {
                field: "sdoMetaPKey",
                value: me.getPKey(),
        ...
        function (recordType) {
          ...
          return BoFactory.loadListAsync("LoInventoryMetaByPaymentMeta", {
            params: [
              {
                field: "sdoMetaPKey",
                value: me.getPKey(),
        ...
        function (loPrdGroupLevelCriterionMappingJson) {
          ...
          if ((me.getItemListOption() == "Hierarchy") && (me.getMobilityRelevant() == "1")) {
            return BoFactory.loadListAsync(LO_ORDERMETAPRDSELECTOR, {
              params: [
                {
                  field: "sdoMetaPKey",
                  value: me.getPKey(),
