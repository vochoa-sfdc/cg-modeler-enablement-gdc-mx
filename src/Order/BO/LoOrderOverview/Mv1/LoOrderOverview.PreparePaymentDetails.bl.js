...
orderItems.forEach(function(item) {
  ...
  var hasValidDocumentTransactionType =
    item.getDocTaType() === "CashOrder" ||
    item.getDocTaType() === "CreditOrder" ||
    item.getDocTaType() === "VanSalesCashInvoice" ||
    item.getDocTaType() === "CashInvoice" ||
    item.getDocTaType() === "InvoiceCashInvoice" ||
    item.getDocTaType() === "InvoiceCreditInvoice";
