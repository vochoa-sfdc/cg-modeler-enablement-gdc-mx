 ...
 * @description The function copies all signature blobs from the current order to a specified splitting document, ensuring each signature is correctly linked and updated.
 * @this BoOrder
 * @kind businessobject
 * @async
 * @namespace CORE
