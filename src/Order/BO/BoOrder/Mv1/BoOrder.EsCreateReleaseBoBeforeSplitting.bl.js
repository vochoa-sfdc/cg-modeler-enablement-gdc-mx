 ...
 * @description This function ensures the release process business object (Bo) is loaded before splitting an invoice, loading it asynchronously if it is not already defined.
 * @this BoOrder
 * @kind businessobject
 * @async
 * @namespace CORE
