 ...
 * @description Validates items in delivery orders, checks if modified items require a reason code for the modification, displays a message box prompting the user to provide a reason when required
 * @returns promise
 */
