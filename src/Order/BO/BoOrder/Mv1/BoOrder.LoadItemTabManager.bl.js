 ...
 * @async
 * @namespace CORE
 * @description Initializes and configures ItemTabManager for an order. It sets up item hierarchy, category visibility, and product addition criteria. If the order phase allows, 
 * it configures product scanning and assigns unit of measures.
 * @returns promise
 */
function loadItemTabManager(){
    var me = this;
