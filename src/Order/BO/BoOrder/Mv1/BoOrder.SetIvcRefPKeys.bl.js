 ...
 * @namespace CORE
 * @description Function is setting inventory reference key according to order template configuration
 */
function setIvcRefPKeys(){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
...
var luRunningTour = ApplicationContext.get(BLConstants.APPCTX.DSD.CURRENT_TOUR);
