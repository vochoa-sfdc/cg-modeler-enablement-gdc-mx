...
.then(function (selfJson) {
  ...
  return Facade.getListAsync("LoOrderItems", {
    params: [
      {
        field: "orderPkey",
        value: me.getPKey(),
...
.then(function (loOrderItemsJson) {
  ...
  return BoFactory.loadListAsync("LoOrderAttachment", {
    params: [
      {
        field: "sdoMainPKey",
        value: me.getPKey(),
...
.then(function (attachment) {
  ...
  return BoFactory.loadObjectByParamsAsync(BO_ORDERMETA, {
    params: [
      {
        field: "pKey",
...
.then(function (boOrderMeta) {
  ...
  return BoFactory.loadObjectByParamsAsync("LoOrderPayments", {
    params: [
      {
        field: "sdoMainPKey",
        value: me.getPKey(),
...
then(function (loInventoryTransaction){
  if(Utils.isDefined(loInventoryTransaction)){
    me.setLoInventoryTransactions(BoFactory.instantiate("LoInventoryTransaction"));
  ...
  return BoFactory.loadObjectByParamsAsync("LoSysSignatureBlob", {
    params: [
      {
        field: "referencePKey",
        value: me.getPKey(),
...
.then(function (LoSysSignatureAttribute){
  if (Utils.isDefined(LoSysSignatureAttribute))  {
    me.setLoSysSignatureAttribute(BoFactory.instantiate("LoSysSignatureAttribute"));
