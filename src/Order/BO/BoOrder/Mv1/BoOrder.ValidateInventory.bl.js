 ...
 * @description Validates inventory for an order, processes inventory actions when releasing an order, collects validation messages, and handles the reset of inventory related list objects when release is aborted.
 * @returns promise
 */
