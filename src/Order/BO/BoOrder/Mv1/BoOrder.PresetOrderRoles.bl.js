 ...
 * @param {DomPKey} pKey
 * @returns promise
 * @description Function is setting the roles for the order document
 */
...
var promise = me.loadLookupsAsync(jsonParams)
...
.then(function (customerDetailPresent) {
  if (customerDetailPresent){
    ...
    return BoFactory.loadObjectByParamsAsync("LoBpaRole",
      { 
        "params": [
          { "field": "customerPKey", 
            "value":  me.getOrdererPKey(), 
            "operator": "EQ" 
          }
        ] 
      } 
