 ...
 * @description Handles free items associated with a reward in an order.It updates item quantities, manages pricing updates, and modifies order 
 * item properties based on reward eligibility and per-factor changes. Also ensures free items are correctly added, updated, or removed as needed.
 * @returns promise
 */
      ...
      if(itemsInOrder.length > 0 ) {
        ...
        if(item.getQuantity() > 0) {
          ...
          var itemForAdd = {
            ...
            "groupIdSort" : "1001$",
            "history" : "0",
            //set new free item to isOrderUnit = 1  --> needed to generate the UoM information string visible in order UI
            "isOrderUnit" : "1",
            "listed" : "0",
