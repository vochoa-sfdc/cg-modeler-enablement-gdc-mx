 ...
 * @namespace CORE
 * @description This function calculates the ErpId of the order items
 * 
 * Example 1: 
 *  Item 1 (parent with no children) --> ErpId: 10
 *  Item 2 (parent with no children) --> ErpId: 20
 *  Item 3 (parent with no children) --> ErpId: 30
 * 
 * Example 2: 
 *  Item 1 (parent)           --> ErpId: 10
 *  Item 2 (child of Item 1)  --> ErpId: 11
 *  Item 3 (child of Item 1)  --> ErpId: 12
 *  Item 4 (parent)           --> ErpId: 20
 *  Item 5 (child of Item 4)  --> ErpId: 21
 *  Item 6 (child of Item 4)  --> ErpId: 22
 */
function setItemErpIds(){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
...
for(i = 0; i < filteredItems.length; i++){
  ...
  if (currentItem.parentType === "Order"){
    parentPKey = me.pKey;
  }
