 ...
 * @description The function sets header attributes and pricing information for a splitting document, including generating new primary keys and handling invoice IDs.
 * @this BoOrder
 * @kind businessobject
 * @async
 * @namespace CORE
