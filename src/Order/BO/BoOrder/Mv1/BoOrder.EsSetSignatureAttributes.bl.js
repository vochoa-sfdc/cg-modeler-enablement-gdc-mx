 ...
 * @description The function sets the signature attributes for a splitting document by copying signature information from the release process business object (Bo) and updating the primary keys of the signature blobs.
 * @this BoOrder
 * @kind businessobject
 * @async
 * @namespace CORE
