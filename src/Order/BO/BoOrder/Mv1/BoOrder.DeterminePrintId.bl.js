  ...
  if(documentType === 'OrderEntry'){
    switch(documentTransactionType){
      ...
      case "VanSalesCashInvoice":
        printId = BLConstants.Order.VAN_SALES_CASH_INVOICE_PDF;
        break;
      case "VanSalesNoPaymentInvoice":
        printId = BLConstants.Order.VAN_SALES_NO_PAYMENT_INVOICE_PDF;
        break;
    }
    ...
    switch(documentTransactionType){
      case "CashInvoice":
        printId = BLConstants.Order.DELIVERY_CASH_INVOICE_PDF;
        break;
      case "CreditInvoice":
        printId = BLConstants.Order.DELIVERY_CREDIT_INVOICE_PDF;
        break;
      case "ValuatedDeliveryNote":
      case "NonValuatedDeliveryNote":
        printId = BLConstants.Order.ORDER_CONFIRMATION_PDF;
        break;
    }
  } 
...
if(Utils.isEmptyString(printId)){
  switch(documentType){
    case "Invoice":
      printId = BLConstants.Order.STORE_TRANSFER_PDF;
      break;
    case BLConstants.Order.DOCUMENT_TYPE_ORDER_ENTRY:
      printId = BLConstants.Order.ORDER_CONFIRMATION_PDF;
      break;
    default:
      printId = BLConstants.Order.ORDER_CONFIRMATION_PDF;
