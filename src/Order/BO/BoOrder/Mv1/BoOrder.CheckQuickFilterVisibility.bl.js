 ...
 * @description Determines the visibility of a quick filter based on the filterby, consider selectable promotion.
 * @returns visible
 */
...
if(filterBy === "Group" && isInContextOfSelectablePromotion){
  visible = true;
} 
