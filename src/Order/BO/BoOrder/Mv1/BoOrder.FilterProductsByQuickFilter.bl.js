 ...
 * @description This function filters a list of products based on a specified quick filter. It supports either "Group" or "Category" and updates the product list,clears the filter, and applies the filter accordingly.
 * @this BoOrder
 * @kind businessobject
 * @namespace CORE
...
else if (previousAppliedGroup.length === 0 && items[0].specialOption !== "CLEAR" && currentAppliedGroup.length > 0) {
  currentAppliedGroup[0].setIsSelected(true);
}
