 ...
 * @description This function updates the filter basket count for a given item.
 *  The count is a combined string. It is the number of the different ordered products followed by the total value of the order.
 *  This count string is visible on the basket tab at the footer of the order screen.
 */
