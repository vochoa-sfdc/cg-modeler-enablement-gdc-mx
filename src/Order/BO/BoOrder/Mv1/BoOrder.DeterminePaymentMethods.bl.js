 ...
 * @async
 * @namespace CORE
 * @description This function determines the payment method based on document type and document transaction type.
 * @returns promise
 */
function determinePaymentMethods(){
    var me = this;
...
var isCashCreditOrderPaymentAllowed = (me.getDocumentType() === BLConstants.Order.DOCUMENT_TYPE_ORDER_ENTRY) &&
    (me.getDocTaType() === "CashOrder" || me.getDocTaType() === "CreditOrder" || me.getDocTaType() === "VanSalesCashInvoice");
var isCashCreditDeliveryOrderPaymentAllowed = (me.getDocumentType() === BLConstants.Order.DOCUMENT_TYPE_DELIVERY) &&
    (me.getDocTaType() === "CashInvoice" || me.getDocTaType() === "CreditInvoice");
...
var paymentAllowed = isCashCreditOrderPaymentAllowed || isCashCreditDeliveryOrderPaymentAllowed || isCashCreditInvoicePaymentAllowed;
