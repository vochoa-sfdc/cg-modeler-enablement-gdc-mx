 ...
 * @kind businessobject
 * @namespace CORE
 * @description This functions stores selected reward information as JSON string in 'selectedRewards' property.
 *  This information is needed after re-opening an order. Then selected rewards should be still selected.
 *  Storing applicable and selected rewards (and their free items) in the form:
 *  {promotionId: [
 *    {id: rewardGroupId, 
 *     rewards: [
 *      {id: rewardId, freeItems: [{id, quantity}]}
 *   ] 
 *  }]
 */
function storeRewardInformation(){
