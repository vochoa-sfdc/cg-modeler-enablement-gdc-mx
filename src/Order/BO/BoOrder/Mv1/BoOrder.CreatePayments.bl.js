 ...
 * @async
 * @namespace CORE
 * @description Manages payments for an order by loading existing payments, removing invalid ones, and creating or updating payment records with relevant details.
 * @returns promise
 */
function createPayments(){
    var me = this;
