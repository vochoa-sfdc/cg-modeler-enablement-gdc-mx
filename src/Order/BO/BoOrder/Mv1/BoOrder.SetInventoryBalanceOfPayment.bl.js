 ...
 * @description Checks if an Inventory with the same keys already exists. If it does, retrieves the Inventory ID and balance. If it doesn't, sets the Inventory ID to empty and the balance to zero.
 * @returns promise
 */
