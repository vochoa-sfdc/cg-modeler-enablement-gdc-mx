 ...
 * @async
 * @namespace CORE
 * @description Loads the workflow for the order and sets the release button visibility. Returns a promise.
 * @returns promise
 */
function loadWorkflow(){
    var me = this;
    ...
    //                                                                                           //
    ///////////////////////////////////////////////////////////////////////////////////////////////
    var promise = BoFactory.loadObjectByParamsAsync(BO_WORKFLOW, {
      params: [
        {
          field: "pKey",
