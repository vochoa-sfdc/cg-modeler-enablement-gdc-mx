 ...
 * @returns me
 * @description Determines which Action are visible in the "Your Activities For Today" card in Visit Cockpit
 */
function getActivitiesForCard(CallStatus, mobilityUserGuidance, isReadOnly){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
  ...
  var isCallReadOnly = isReadOnly;

  //fallback if isReadOnly flag is not handed over
  if (!Utils.isDefined(isCallReadOnly)) {
    isCallReadOnly = CallStatus != BLConstants.VISIT.STATUS_COMPLETED && CallStatus != BLConstants.VISIT.STATUS_ABANDONED;
  }
  ...
  if (!isCallReadOnly && mobilityUserGuidance == "Sales") {
    var menuEntry2 = {
      "id": "CreateOrder",
  ...
  if (mobilityUserGuidance == "Merchandizing" || mobilityUserGuidance == "Sales" || ApplicationContext.get(BLConstants.APPCTX.HYBRID.HYBRIDMODE)) {
    var menuEntry3 = {
      "id": "TrackAssets",
