 ...
 * @returns promise
 * @description this function filters and retrieves call entries to be displayed on a card based on specified criteria.
 */
...
me.setFilter("dateFrom", currentDate, "EQ");
