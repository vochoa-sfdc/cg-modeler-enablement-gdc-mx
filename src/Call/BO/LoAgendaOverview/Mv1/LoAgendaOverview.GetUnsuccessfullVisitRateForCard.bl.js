 ...
 * @returns promise
 * @description this function calculates the unsuccessful visit rate for a card by analyzing calls within a specified week.
 */
...
if(!Utils.isDefined(currentDate)){
  currentDate = Utils.createDateToday();
} else{
