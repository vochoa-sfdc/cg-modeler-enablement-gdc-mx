 ...
 * @description Ensures correct visit duration updates for all-day and time-based vists.Handles completion actions like updating last visit dates, capturing location,  
 * setting completion times, and resetting magnetization on validation errors. Updates planned times if required by vist template.
 * @this BoCall
