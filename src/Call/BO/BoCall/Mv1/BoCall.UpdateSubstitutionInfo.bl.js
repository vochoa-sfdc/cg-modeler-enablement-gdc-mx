 ...
 * @namespace CORE
 * @description Updates substitution details for a call based on customer management info. Determines if the call is substituted, assigns the appropriate substitution keys, and sets the call to read-only when necessary.
 */
function updateSubstitutionInfo(){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
