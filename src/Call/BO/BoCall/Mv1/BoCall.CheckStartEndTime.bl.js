 ...
 * @kind businessobject
 * @namespace CORE
 * @description This function is checking and correcting timezone differences between start and stop time of the visit
...
function checkStartEndTime(){
  ...
  //only correct times of start and end time offsets are available
  if (Utils.isDefined(me.getStartTimeEffectiveTimezoneOffset()) && Utils.isDefined(me.getStopTimeEffectiveTimezoneOffset())) {
    // if stopTime is set  
    if (me.getStopTimeEffective() !== Utils.getMinDate() && me.getOriginalClbStatus() !== BLConstants.VISIT.STATUS_COMPLETED) {
      ...
      if (me.getStartTimeEffectiveTimezoneOffset() != me.getStopTimeEffectiveTimezoneOffset()) {
        ...
        var currentOffset = Utils.createDateNow().getTimezoneOffset();
        ...
        if (currentOffset == me.getStartTimeEffectiveTimezoneOffset()) {
          ...
          me.setStopTimeEffectiveTimezoneOffset(currentOffset);
          ...
          me.setStartTimeEffectiveTimezoneOffset(currentOffset);
