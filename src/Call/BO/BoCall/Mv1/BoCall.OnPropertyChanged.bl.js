 ...
 * @description this function updates the property of bo job manager when visit properties are changed
 */
...
if ((handlerParams.oldValue != handlerParams.newValue) && (Utils.isDefined(jobManager))) {
  switch (handlerParams.simpleProperty) {
    case "clbStatus":
      ...
      if(handlerParams.newValue === BLConstants.VISIT.STATUS_COMPLETED){
