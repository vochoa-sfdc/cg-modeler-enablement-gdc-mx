 ...
 * @returns promise
 * @description This function cancels the visit and delete related records, also captures the position is enabled in the visit template
 */
...
me.setClbStatus(BLConstants.VISIT.STATUS_ABANDONED);
