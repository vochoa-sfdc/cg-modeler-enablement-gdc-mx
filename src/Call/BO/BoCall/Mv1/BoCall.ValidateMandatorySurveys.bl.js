 ...
 * @async
 * @namespace CORE
 * @description Validates that all mandatory surveys are completed before the visit completion. It checks survey prerequisites, retrieves job definitions, and verifies survey completion.  
 * Missing surveys trigger validation errors, which are collected and returned.  
 * @returns promise
 */
function validateMandatorySurveys(){
    var me = this;
