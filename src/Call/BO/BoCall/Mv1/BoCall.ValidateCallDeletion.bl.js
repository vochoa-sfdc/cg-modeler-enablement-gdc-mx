 ...
 * @async
 * @namespace CORE
 * @description Validates whether a BoCall object can be deleted. If the call has referenced orders, an error message is displayed, and deletion is prevented. Otherwise, the call is marked as valid for deletion.
 * @returns promise
 */
function validateCallDeletion(){
    var me = this;
...
var promise = BoFactory.loadObjectByParamsAsync("LuHasReferencedOrder", {
  params: [
    {
      field: "clbMainPKey",
      value: me.getPKey(),
