 ...
 * @description this function sets the edit access rights based on template and other settings
 */
...
var isDSDMode = jsonQuery && jsonQuery.isCallFromDSD;

var isCallReadOnly = me.isReadOnly(isDSDMode);
...
if (isCallReadOnly) {
  ...
  aclBo.addRight(AclObjectType.OBJECT, "BoCall", AclPermission.EDIT);
}
...
if (me.getLuCallMeta().getMobilityUserGuidance() == "NonCustomer" 
