 ...
 * @returns posId
 * @description Filtering Questions to the current POS and handle visibilty of Question fields via setEARights function
 */
function filterQuestions(posId, isReadOnly){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
  ...
  if (me.getClbStatus() === BLConstants.VISIT.STATUS_PLANNED) {
    ...
    loQuestions.setEARights(isReadOnly);
  } else if (me.getClbStatus() === BLConstants.VISIT.STATUS_INPROGRESS) {
    me.evaluateQuestions(loQuestions.getItems());
