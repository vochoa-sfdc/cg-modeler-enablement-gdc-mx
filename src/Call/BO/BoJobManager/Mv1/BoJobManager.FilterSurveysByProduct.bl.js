 ...
 * @namespace CORE
 * @description Function is loading survey and survey products and sets filters, like promotion and discrepancies, based on the arguments.
...
if (Utils.isDefined(this.getLoPOS().getCurrent()) && Utils.isDefined(this.getLoPOS().getCurrent().getSurveys())){
  ...
  this.get('loCurrentSurveys').addItemChangedEventListener(this.onSurveyChanged, this, 'loCurrentSurveys');
}
