 ...
 * @description Asynchronously loads and sets the `clbMainPKey` value from the provided JSON query parameters. Returns a resolved promise with the updated object.
 * @returns promise
 */
