 ...
 */
function setOnlyRelevantFilterAfterAction(issueDetail, currentFilter){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
if (Utils.isDefined(currentFilter) && currentFilter === 'OnlyActiveIssues') {
...
if (items.length > 0) {
  me.setCurrentByPKey(issueDetail.getPKey());
} else {
