 ...
 * @description Loads and configures context menu items (Cancel, Delete, Copy) for issue overview based on user permissions and issue state
...
var promise = BoFactory.loadObjectByParamsAsync("BoWorkflow", {
  params: [
    {
      field: "pKey",
      value: context.jsonQuery.wfeWorkflowPKey,
      operator: "EQ"
    }
  ]
}).then( 
