...
var promise = me.loadLookupsAsync(jsonParams).then(
  function (lookups) {
    copyBO.assignLookups(lookups);

    return BoFactory.loadObjectByParamsAsync("BoWorkflow", {
      params: [
        {
          field: "pKey",
          value: copyBO.getWfeWorkflowPKey(),
          operator: "EQ"
        }
      ]
    });
  ...
  function (boSlogan) {
    ...
    loPrmCttTactics.addItems(copiedItems);
    ...
    loPrmCttProducts.addItems(copiedItems);
    ...
    loComment.addItems(copiedItems);
